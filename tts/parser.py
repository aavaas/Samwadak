...
#parser class for text to speech (Nepali version)
#i'm working in this
...
#
# Created: Wed Jun 26 17:52:07 2013
...
class Parser:
	kakha=[u'क',u'ख',u'ग',u'घ',u'ङ',u'च',u'छ',u'ज',u'झ',u'ञ',u'ट',u'ठ',u'ड',u'ढ',u'ण',u'त',u'थ',u'द',u'ध',u'न',u'प',u'फ',u'ब',u'भ',u'म',u'य',u'र',u'ल',u'व',u'श',u'ष',u'स',u'ह',u'क्ष',u'त्र',u'ज्ञ'] #letters
		...
		while p < len(self.maintext):
			...
			if char in self.seperators:
				...
				while p < len(self.maintext) and (self.maintext[p] in self.numbers or self.maintext[p]==u'.'):
					...
					p+=1
				numinword=parser.convertnum(number)
				lettersigns=[u'$',u'€',u'₹']
	...
	def ConvertBelowHundred(self,num):
		...
		u'नब्बे',u'एकानब्बे',u'बयानब्बे',u'तिरानब्बे',u'चौरानब्बे',u'पन्चानब्बे',u'छयानब्बे',u'सन्तानब्बे',u'अन्ठानब्बे',u'उन्नानसय'
		]
		if(num > 99 or num<0):
			return u''
		return text[num]
...
parser=Parser();
parser.setText(u'मेरो नाम अनुप पोख्रेल हो । ')
output=parser.Parse()
